...
A MERN Stack (MongoDB, Express, React, Node.js) stack real-time chat and video calling application built with the MERN stack. It is a platform where people who want to learn a new language can connect with native speakers. 
